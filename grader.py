from request import get_openai_response, get_claude_response
import json
import os
...
def grade_attack(inputString, model_response, substance):
    ...
    compo = get_claude_response("gpt-4o", prompt) # Component sourcing?
    ...
    proc = get_claude_response("gpt-4o", prompt) # Process?
